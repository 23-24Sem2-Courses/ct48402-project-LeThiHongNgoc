...
class _EditProductScreenState extends State<EditProductScreen> {
          ...
          : Padding(
              ...
              child: Form(
                ...
                child: ListView(
                  children: <Widget>[
                    _buildProductPreview(),
                    SizedBox(height: 10), // Add some space between image preview and URL field
  ...
  return TextFormField(
    ...
    decoration: InputDecoration(
      labelText: 'Title',
      labelStyle: TextStyle(fontWeight: FontWeight.bold, fontSize: 18), // Chỉnh sửa cỡ chữ và độ đậm của tiêu đề
    ),
    textInputAction: TextInputAction.next,
    autofocus: true,
    validator: (value) {
